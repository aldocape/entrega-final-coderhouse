...
exports.compareProducts = exports.deleteAllProducts = exports.deleteProductById = exports.updateProduct = exports.getManyProducts = exports.getProductById = exports.getAllProducts = exports.saveProduct = void 0;
...
function getManyProducts(query) {
    return __awaiter(this, void 0, void 0, function* () {
        const products = yield (0, daos_1.getMany)('product', query);
        return products;
    });
}
...
function compareProducts(obj1, obj2) {
    return (0, daos_1.compare)('product', obj1, obj2);
}
